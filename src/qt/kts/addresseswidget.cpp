...
#include "qt/kts/forms/ui_addresseswidget.h"
#include "qt/kts/addresslabelrow.h"
#include "qt/kts/addnewaddressdialog.h"
...
void AddressesWidget::onStoreContactClicked(){
    if (walletModel) {
        ...
        CBitcoinAddress ktsAdd = CBitcoinAddress(address.toUtf8().constData());
