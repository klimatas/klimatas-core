...
#ifndef KTS_CORE_NEW_GUI_KTSGUI_H
#define KTS_CORE_NEW_GUI_KTSGUI_H
...
#include "qt/kts/topbar.h"
#include "qt/kts/dashboardwidget.h"
#include "qt/kts/send.h"
#include "qt/kts/receivewidget.h"
#include "qt/kts/addresseswidget.h"
#include "qt/kts/privacywidget.h"
#include "qt/kts/coldstakingwidget.h"
#include "qt/kts/masternodeswidget.h"
#include "qt/kts/snackbar.h"
#include "qt/kts/settings/settingswidget.h"
...
/**
  KTS GUI main class. This class represents the main window of the KTS UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class KTSGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit KTSGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~KTSGUI();
...
#endif //KTS_CORE_NEW_GUI_KTSGUI_H
