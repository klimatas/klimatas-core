...
RESOURCES += src/qt/klimatas.qrc src/qt/klimatas_locale.qrc

TRANSLATIONS += src/qt/locale/klimatas_bg.ts \
                src/qt/locale/klimatas_de.ts \
                src/qt/locale/klimatas_en.ts \
                src/qt/locale/klimatas_es.ts \
                src/qt/locale/klimatas_fi.ts \
                src/qt/locale/klimatas_fr.ts \
                src/qt/locale/klimatas_it.ts \
                src/qt/locale/klimatas_ja.ts \
                src/qt/locale/klimatas_pl.ts \
                src/qt/locale/klimatas_pt.ts \
                src/qt/locale/klimatas_ru.ts \
                src/qt/locale/klimatas_sk.ts \
                src/qt/locale/klimatas_sv.ts \
                src/qt/locale/klimatas_vi.ts \
                src/qt/locale/klimatas_zh_CN.ts \
                src/qt/locale/klimatas_zh_TW.ts
