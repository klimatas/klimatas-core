...
#include "qt/kts/coincontrolktswidget.h"
#include "qt/kts/forms/ui_coincontrolktswidget.h"

CoinControlKtsWidget::CoinControlKtsWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlKtsWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select KTS Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("KTS");
    ...
    ui->labelValueAfter->setText("0.00 KTS");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 KTS");
    ui->labelValueFee->setText("0.00 KTS");
...
CoinControlKtsWidget::~CoinControlKtsWidget()
{
    delete ui;
}
