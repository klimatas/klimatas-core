...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Klimatas server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Klimatas server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Klimatas features */
        {"klimatas", "masternode", &masternode, true, true, false},
        {"klimatas", "listmasternodes", &listmasternodes, true, true, false},
        {"klimatas", "getmasternodecount", &getmasternodecount, true, true, false},
        {"klimatas", "masternodeconnect", &masternodeconnect, true, true, false},
        {"klimatas", "masternodecurrent", &masternodecurrent, true, true, false},
        {"klimatas", "masternodedebug", &masternodedebug, true, true, false},
        {"klimatas", "startmasternode", &startmasternode, true, true, false},
        {"klimatas", "createmasternodekey", &createmasternodekey, true, true, false},
        {"klimatas", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"klimatas", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"klimatas", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"klimatas", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"klimatas", "getmasternodescores", &getmasternodescores, true, true, false},
        {"klimatas", "mnbudget", &mnbudget, true, true, false},
        {"klimatas", "preparebudget", &preparebudget, true, true, false},
        {"klimatas", "submitbudget", &submitbudget, true, true, false},
        {"klimatas", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"klimatas", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"klimatas", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"klimatas", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"klimatas", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"klimatas", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"klimatas", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"klimatas", "checkbudgets", &checkbudgets, true, true, false},
        {"klimatas", "mnsync", &mnsync, true, true, false},
        {"klimatas", "spork", &spork, true, true, false},
        {"klimatas", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"klimatas", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use klimatasd, or the -server option to klimatas-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> klimatas-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10301/\n";
}
