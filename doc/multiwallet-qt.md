...
In order to support loading of multiple wallets in kts-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is kts.cpp.
...
Changes to kts.cpp
----------------------
kts.cpp is the entry point into kts-qt, and as such, will require some minor modifications to provide hooks for
