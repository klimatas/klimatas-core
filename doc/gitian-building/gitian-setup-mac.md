...
The build script we'll be using is contained in the KTS github repository ([contrib/gitian-build.py](https://github.com/kts-project/kts/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the KTS repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/KTS-Project/KTS/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, kts-detached-sigs, and kts GitHub repos.
