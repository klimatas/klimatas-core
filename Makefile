...
pkgdatadir = $(datadir)/klimatas
pkgincludedir = $(includedir)/klimatas
pkglibdir = $(libdir)/klimatas
pkglibexecdir = $(libexecdir)/klimatas
...
CONFIG_HEADER = $(top_builddir)/src/config/klimatas-config.h
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	...
	$(top_srcdir)/src/config/klimatas-config.h.in \
...
ACLOCAL = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/missing automake-1.15
AWK = gawk
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = klimatas-cli
BITCOIN_DAEMON_NAME = klimatasd
BITCOIN_GUI_NAME = klimatas-qt
BITCOIN_TX_NAME = klimatas-tx
...
MAINT = 
MAKEINFO = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
MINIUPNPC_LIBS = 
...
OTOOL64 = 
PACKAGE = klimatas
PACKAGE_BUGREPORT = www.klimatas.io
PACKAGE_NAME = Klimatas Core
PACKAGE_STRING = Klimatas Core 2.4.0
PACKAGE_TARNAME = klimatas
PACKAGE_URL = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = 
abs_builddir = /home/mitchel/Desktop/build/klimatas-linux
abs_srcdir = /home/mitchel/Desktop/build/klimatas-linux
abs_top_builddir = /home/mitchel/Desktop/build/klimatas-linux
abs_top_srcdir = /home/mitchel/Desktop/build/klimatas-linux
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/mitchel/Desktop/build/klimatas-linux/build-aux/install-sh
...
COVERAGE_INFO = baseline_filtered_combined.info baseline.info block_test.info \
  leveldb_baseline.info test_klimatas_filtered.info total_coverage.info \
  baseline_filtered.info block_test_filtered.info \
  leveldb_baseline_filtered.info test_klimatas_coverage.info test_klimatas.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/bitcoin.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/Klimatas-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/klimatas-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/klimatas-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/klimatas-config.h
$(top_srcdir)/src/config/klimatas-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/klimatas-config.h src/config/stamp-h1
...
$(OSX_APP)/Contents/MacOS/Klimatas-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Klimatas-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/Klimatas-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_klimatas.info: baseline_filtered_combined.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c -d $(abs_builddir)/src -t test_klimatas -o $@
#	$(LCOV) -z -d $(abs_builddir)/src
#	$(LCOV) -z -d $(abs_builddir)/src/leveldb

#test_klimatas_filtered.info: test_klimatas.info
#	$(LCOV) -r $< "/usr/include/*" -o $@

#block_test.info: test_klimatas_filtered.info
#	$(MKDIR_P) qa/tmp
...
#test_klimatas_coverage.info: baseline_filtered_combined.info test_klimatas_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_klimatas_filtered.info -o $@

#total_coverage.info:  baseline_filtered_combined.info test_klimatas_filtered.info block_test_filtered.info
#	$(LCOV) -a baseline_filtered.info -a leveldb_baseline_filtered.info -a test_klimatas_filtered.info -a block_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_klimatas.coverage/.dirstamp:  test_klimatas_coverage.info
#	$(GENHTML) -s $< -o $(@D)
#	@touch $@
...
#cov: test_klimatas.coverage/.dirstamp total.coverage/.dirstamp

.INTERMEDIATE: $(COVERAGE_INFO)

clean-local:
	rm -rf test_klimatas.coverage/ total.coverage/ $(OSX_APP)
