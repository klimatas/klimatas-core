...
class BudgetProposalTest(KtsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Test with invalid KTS address")
        assert_raises_rpc_error(-5, "Invalid KTS address", self.nodes[0].preparebudget,
        ...
        assert_raises_rpc_error(-8, "Invalid amount - Payment of 9.00 is less than minimum 10 KTS allowed", self.nodes[0].preparebudget,
