...
The script [extract-osx-sdk.sh](https://github.com/kts-project/kts/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
kts/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/kts-project/kts/blob/master/doc/README_osx.md) for troubleshooting tips.