...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Klimatas Core klimatas-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  klimatas-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded klimatas transaction") + "\n" +
                               "  klimatas-tx [options] -create [commands]   " + _("Create hex-encoded klimatas transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded klimatas transaction
