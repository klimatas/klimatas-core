...
UniValue mnbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp ||
        ...
        throw runtime_error(
            ...
            "  vote-many          - Vote on a KTS initiative\n"
            "  vote-alias         - Vote on a KTS initiative\n"
            "  vote               - Vote on a KTS initiative/budget\n"
...
UniValue submitbudget(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 7)
        throw runtime_error(
            "submitbudget \"proposal-name\" \"url\" payment-count block-start \"kts-address\" monthy-payment \"fee-tx\"\n"
