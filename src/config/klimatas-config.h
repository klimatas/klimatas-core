/* src/config/klimatas-config.h.  Generated from klimatas-config.h.in by configure.  */
/* src/config/klimatas-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Klimatas_CONFIG_H

#define Klimatas_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.klimatas.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Klimatas Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Klimatas Core 2.4.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "klimatas"
