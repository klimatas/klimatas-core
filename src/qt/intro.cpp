...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Klimatas Core"),
     ...
     * override -datadir in the klimatas.conf file in the default data directory
     * (to be consistent with klimatasd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
