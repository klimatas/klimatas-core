                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzKTSPathCustom = GetArg("-zktsbackuppath", "");
    ...
    if(!strzKTSPathCustom.empty()) {
        ui->wallet_customzktsbackuppath->setText(QString::fromStdString(strzKTSPathCustom));
        ui->wallet_customzktsbackuppath_label->setVisible(true);
        ui->wallet_customzktsbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzKTSPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the KTS RPC console.") + "<br>" +
