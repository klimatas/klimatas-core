                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Klimatas Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Klimatas address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and klimatas: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zKTS"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Klimatas Core"), this);
    aboutAction->setStatusTip(tr("Show information about Klimatas Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Klimatas"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Klimatas addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Klimatas addresses"));
    ...
    openAction->setStatusTip(tr("Open a Klimatas: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Klimatas Core help message to get a list with possible Klimatas command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Klimatas Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Klimatas network", "", count));
}
...
{
    QString strTitle = tr("Klimatas Core"); // default title
