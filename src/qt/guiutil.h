...
/** Utility functions used by the Klimatas Qt UI.
 */
namespace GUIUtil
{
...
// Render Klimatas addresses in monospace font
...
// Parse "klimatas:" URI into recipient object, return true on successful parsing
