...
#include "qt/kts/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/kts/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(KTSGUI* _window, QWidget *parent) :
