...
#include "qt/kts/furabstractlistitemdelegate.h"
...
#include "config/kts-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalKts = 0;
    qint64 totalZkts = 0;
    QList<qreal> valuesKts;
    QList<qreal> valueszKts;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(KTSGUI* _window);
    ~DashboardWidget();
