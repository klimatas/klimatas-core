...
"""Verify that starting kts with -h works as expected."""
import subprocess

from test_framework.test_framework import KtsTestFramework
from test_framework.util import assert_equal

class HelpTest(KtsTestFramework):
    ...
    def run_test(self):
        self.log.info("Start kts with -h for help text")
        ...
        self.log.info("Start kts with -version for version information")
