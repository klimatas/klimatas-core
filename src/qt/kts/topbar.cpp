...
#include "qt/kts/forms/ui_topbar.h"
#include <QPixmap>
#include "qt/kts/lockunlock.h"
#include "qt/kts/qtutils.h"
#include "qt/kts/receivedialog.h"
...
void TopBar::updateBalances(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance,
    ...
    // KTS Total
    CAmount ktsAvailableBalance = balance;
    // zKTS Balance
