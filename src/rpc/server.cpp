...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"kts", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"kts", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"kts", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"kts", "masternodecurrent", &masternodecurrent, true, true, false},
        {"kts", "masternodedebug", &masternodedebug, true, true, false},
        {"kts", "startmasternode", &startmasternode, true, true, false},
        {"kts", "createmasternodekey", &createmasternodekey, true, true, false},
        {"kts", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"kts", "listmasternodeconf", &listmasternodeconf, true, true, false},
        ...
        {"kts", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"kts", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"kts", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"kts", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"kts", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"kts", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"kts", "checkbudgets", &checkbudgets, true, true, false},
        {"kts", "mnsync", &mnsync, true, true, false},
        {"kts", "spork", &spork, true, true, false},
        {"kts", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzktsseed", &getzktsseed, false, false, true},
...
{
    return "> kts-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:10401/\n";
}
