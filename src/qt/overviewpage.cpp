...
//    ui->labelzKTSPercent->setText(szPercentage);
    ...
    if (fEnableZeromint) {
        ...
        automintHelp += tr("To disable AutoMint delete set 'enablezeromint=1' to 'enablezeromint=0' in klimatas2.conf.");
    }
    else {
        automintHelp += tr("AutoMint is currently disabled.\nTo enable AutoMint add 'enablezeromint=1' in klimatas2.conf");
    }
//    ui->labelzKTSPercent->setToolTip(automintHelp);
