...
// Copyright (c) 2015-2018 The KTSX developers
...
/* Kts GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "KTS"
#define QAPP_ORG_DOMAIN "kts.org"
#define QAPP_APP_NAME_DEFAULT "KTS-Qt"
#define QAPP_APP_NAME_TESTNET "KTS-Qt-testnet"
