...
RESOURCES += src/qt/kts.qrc src/qt/kts_locale.qrc

TRANSLATIONS += src/qt/locale/kts_bg.ts \
                src/qt/locale/kts_de.ts \
                src/qt/locale/kts_en.ts \
                src/qt/locale/kts_es.ts \
                src/qt/locale/kts_fi.ts \
                src/qt/locale/kts_fr.ts \
                src/qt/locale/kts_it.ts \
                src/qt/locale/kts_ja.ts \
                src/qt/locale/kts_pl.ts \
                src/qt/locale/kts_pt.ts \
                src/qt/locale/kts_ru.ts \
                src/qt/locale/kts_sk.ts \
                src/qt/locale/kts_sv.ts \
                src/qt/locale/kts_vi.ts \
                src/qt/locale/kts_zh_CN.ts \
                src/qt/locale/kts_zh_TW.ts
