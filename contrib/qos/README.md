...
This means one can have an always-on klimatasd instance running, and another local klimatasd/klimatas-qt instance which connects to this node and receives blocks from it.
