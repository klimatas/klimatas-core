...
#include "qt/kts/settings/settingsnetworkwidget.h"
#include "qt/kts/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/kts/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(KTSGUI* _window, QWidget *parent) :
