...
This mechanism has been integrated into Bitcore-Node-KTS which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/CryptoDev-Project/insight-api-kts#web-socket-api](https://github.com/CryptoDev-Project/insight-api-kts#web-socket-api) 
* API: [https://github.com/CryptoDev-Project/insight-api-kts#swifttx-transactions](https://github.com/CryptoDev-Project/insight-api-kts#swifttx-transactions) 
...
By default, the KTS Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the KTS Core daemon:
