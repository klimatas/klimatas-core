...
std::vector<CSporkDef> sporkDefs = {
    ...
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 KTS
    ...
    MAKE_SPORK_DEF(SPORK_20_FORCE_ENABLED_MASTERNODE,       4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_21_COLDSTAKING_REMOVAL,            1644840000ULL), // 2022-02-14 12:00 UTC
    MAKE_SPORK_DEF(SPORK_21_COLDSTAKING_DISABLING,          1675000ULL), // block
};
...
// KTS: on startup load spork values from previous session if they exist in the sporkDB
