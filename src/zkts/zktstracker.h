...
#ifndef KTS_ZKTSTRACKER_H
#define KTS_ZKTSTRACKER_H
...
public:
    CzKTSTracker(std::string strWalletFile);
    ~CzKTSTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzKTSWallet* zKTSWallet = NULL);
